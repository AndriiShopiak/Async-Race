...
export default function pastGarage(data: Cars[]) {
  const app: HTMLElement = document.querySelector(".app");
  app.innerHTML = `
    <h1 class="number_cars_title">Garage(${data.length})</h1>
    <h2 class="page__num">Page #1</h2>`;
  data.forEach((el) => {
    app.innerHTML += `
      <div class="item_track" id="${el.id}">
      <h2 class="app_title">${el.name ? el.name : "Some Car"}</h2>
      <div class="btn_option_con">
        <button class="select_car">Select</button>
        <button class="remove_car">Remove</button>
      </div>
      <div class="btn_option_con">
        <button class="start_btn" style="background:green;">Start</button>
        <button class="stop_btn" style="background:red;">Stop</button>
      </div>
      <div class="car__flag">
      <img src="../assets/img/3.png" alt="finishIcon" class="finish_flag"/>
      ...
      <g transform="translate(0.000000,640.000000) scale(0.100000,-0.100000)" fill="${el.color}" stroke="none">
